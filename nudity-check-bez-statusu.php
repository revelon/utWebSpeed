...
where contentType='image' and pornProbability=0 and status='ok' and public='public' and displayStatus in ('maybe_safe', 'maybe_porn') 
and cdnStatus='ok' and thumbImage != '' and banned=0 
order by hashid desc limit 8000
							 ")) {
